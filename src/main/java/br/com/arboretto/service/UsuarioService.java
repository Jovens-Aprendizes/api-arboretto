...
public class UsuarioService {
	...
	public Usuario salvar(Usuario usuario) {
		 ...
		 * 
		 * 
		 * if (!cargo.equals("inquilino") && !cargo.equals("administrador") &&
		 * !cargo.equals("proprietário")) { throw new
		 * RegraNegocioException("Cargo inválido. Use 'inquilino', 'administrador' ou 'proprietário'."
		 * ); }
		 */
